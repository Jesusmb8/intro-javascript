  ...
  this.disparar = (player2, rondas) => {
    ...
    if (this.logDisparos.includes(disparo)) {
      ...
      if (player2.ownBoard[Constants.LETRAS[fila]][columna] === Constants.INIT_BOARD) {
        ...
        // Corrección
        player2.ownBoard[Constants.LETRAS[fila]][columna] = Constants.AGUA;
      } else {
        // printLine(' Tocado');
        let shipTocado;
          ...
          if (ship.coordenadas.find((coordenadas) => coordenadas === disparo)) {
            ...
            if (ship.disparosRecibidos === ship.size) {
              ...
              ship.coordenadas.forEach((coordenada) => {
                ...
                // Corrección
                player2.ownBoard[fila][columna] = Constants.HUNDIDO;
              });
              // Marcamos tocado
        ...
        if (!shipTocado.hundido) {
          ...
          sigueDisparando = true;
          // Corrección
          player2.ownBoard[Constants.LETRAS[fila]][columna] = Constants.TOCADO;
        }
